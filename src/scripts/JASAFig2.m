plotStyle('StandardStyle','custom','FontStyle','classic','FontSize',26,'LineWidth',1.75,'ColorScheme',1,'AspectRatio','square','PlotSize','medium')
...
arrow2 = annotation('textarrow','String','t = 44 s','FontSize',20,'Color',[0.9290 0.6940 0.1250],'TextColor','k');
arrow2.Parent = ax.CurrentAxes;
arrow2.X = [downrange(44+6)+10 downrange(44+6)];
arrow2.Y = [a(44+6)+10 a(44+6)];

arrow3 = annotation('textarrow','String','t = 100 s','FontSize',20,'Color',[0.4940 0.1840 0.5560],'TextColor','k');
arrow3.Parent = ax.CurrentAxes;
arrow3.X = [downrange(100+6)+1 downrange(100+6)];
arrow3.Y = [a(100+6)+15 a(100+6)];

arrow4 = annotation('textarrow','String','t = 300 s','FontSize',20,'Color',[0.4660 0.6740 0.1880],'TextColor','k');
